...
class Usuario {
    ...
    public function crear() {
        ...
        $this->oni = $this->oni ? htmlspecialchars(strip_tags($this->oni)) : null;
        $this->dui = $this->dui ? htmlspecialchars(strip_tags($this->dui)) : null;
    ...
    public function actualizar() {
        ...
        // Limpiar datos - CORREGIDO para evitar warnings con NULL
        $this->tipo_usuario = htmlspecialchars(strip_tags($this->tipo_usuario ?? 'estudiante_mayor'));
        $this->nombre = htmlspecialchars(strip_tags($this->nombre));
        $this->email = htmlspecialchars(strip_tags($this->email ?? ''));
        $this->telefono = htmlspecialchars(strip_tags($this->telefono ?? ''));
