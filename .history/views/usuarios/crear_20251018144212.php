...
<body>
    <div class="container">
        ...
        <form method="POST" action="index.php?ruta=usuarios/crear" id="formUsuario">
                ...
                <select id="tipo" name="tipo" required>
                    ...
                    <?php foreach ($tiposUsuario as $valor => $texto): ?>
                        <option value="<?php echo $valor; ?>"
                            <?php echo (isset($_POST['tipo']) && $_POST['tipo'] === $valor) ? 'selected' : ''; ?>>
                            <?php echo $texto; ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div id="campoCarnet" class="campo-oculto">
                <div class="form-group">
                    ...
                    <input 
                        ...
                        value="<?php echo isset($_POST['carnet_policial']) ? htmlspecialchars($_POST['carnet_policial']) : ''; ?>"
                    >
            ...
            <div id="campoDUI" class="campo-oculto">
                <div class="form-group">
                    ...
                    <small class="help-text success">
                        ✨ Se generará un token temporal automáticamente
                    </small>
                </div>
            </div>
