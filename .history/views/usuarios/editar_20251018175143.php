    ...
    <div class="container">
        ...
        <form action="?ruta=usuarios/editar&id=<?php echo $usuario['id']; ?>" method="POST">
            ...
            <div>
                ...
                <input type="text" id="carnet_policial" name="carnet_policial" value="<?php echo htmlspecialchars($usuario['carnet_policial']); ?>" <?php echo $usuario['tipo'] !== 'policia' ? 'readonly placeholder="Solo para policías"' : ''; ?>>
            </div>
