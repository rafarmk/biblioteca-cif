            ...
            <form action="index.php?ruta=libros/guardar" method="POST" id="formLibro">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="anio_publicacion" name="año_publicacion" placeholder="<?= date('Y') ?>" min="1000" max="<?= date('Y') ?>">
                    </div>anio_publicacion
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="num_paginas" name="num_paginas" placeholder="Ej: 350" min="1">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="cantidad_total" name="cantidad_total" value="1" min="1" max="100">
