...
class UsuarioController {
    ...
    public function index() {
        echo "DEBUG: Entrando al método index()<br>";
        
        try {
            echo "DEBUG: Obteniendo usuarios...<br>";
            $usuarios = $this->usuario->obtenerTodos();
            echo "DEBUG: Usuarios obtenidos: " . count($usuarios) . "<br>";
            
            $tiposUsuario = Usuario::obtenerTiposUsuario();
            echo "DEBUG: Tipos de usuario obtenidos<br>";
            
            echo "DEBUG: A punto de cargar la vista...<br>";
            
            // Cargar vista
            require_once 'views/usuarios/index.php';
            
            echo "DEBUG: Vista cargada (no deberías ver esto)<br>";
