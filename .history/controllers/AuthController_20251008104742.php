...
require_once __DIR__ . '/../config/conexion.php'; // ✅ Se agregó esta línea
...
class AuthController {
    ...
    public function __construct() {
        $conexion = new Conexion();         // ✅ Se agregó esta línea
        $db = $conexion->conectar();        // ✅ Se agregó esta línea
        $this->usuarioModel = new Usuario($db); // ✅ Se corrigió la instancia
    }
