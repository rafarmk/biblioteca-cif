 ...
 * Versión: 2.1 - Convertido de MySQLi a PDO con alias de compatibilidad
 */
...
class Libro {
    ...
    public function obtenerTodos() {
        ...
        foreach ($libros as &$libro) {
            ...
            // ✅ Agregar alias para compatibilidad con la vista
            $libro['total_copias'] = $libro['cantidad_total'] ?? 0;
            $libro['copias_disponibles'] = $libro['cantidad_disponible'] ?? 0;
            $libro['anio_publicacion'] = $libro['Fatal error: Uncaught PDOException: SQLSTATE[42S22]: Column not found: 1054 Unknown column 'año_publicacion' in 'field list' in C:\laragon\www\biblioteca-cif\models\Libro.php:52 Stack trace: #0 C:\laragon\www\biblioteca-cif\models\Libro.php(52): PDOStatement->execute(Array) #1 C:\laragon\www\biblioteca-cif\controllers\LibroController.php(115): Libro->crear(Array) #2 C:\laragon\www\biblioteca-cif\index.php(137): LibroController->guardar() #3 {main} thrown in C:\laragon\www\biblioteca-cif\models\Libro.php on line 52'] ?? null;;
            $libro['tipo'] = 'fisico'; // Tipo por defecto
            $libro['subtitulo'] = ''; // Campo opcional
        }
    ...
    public function obtenerPorId($id) {
        ...
        if ($resultado) {
            ...
            $resultado['total_copias'] = $resultado['cantidad_total'];
            $resultado['copias_disponibles'] = $resultado['cantidad_disponible'];
            $resultado['anio_publicacion'] = $resultado['año_publicacion'];
    ...
    public function obtenerDisponibles() {
        ...
        foreach ($libros as &$libro) {
            ...
            $libro['categoria_nombre'] = $libro['categoria'];
            $libro['total_copias'] = $libro['cantidad_total'];
            $libro['copias_disponibles'] = $libro['cantidad_disponible'];
            $libro['anio_publicacion'] = $libro['año_publicacion'];
            $libro['tipo'] = 'fisico';
            $libro['subtitulo'] = '';
        }
