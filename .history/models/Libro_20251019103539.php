 ...
 * Versión: 2.2 - Sin ñ en nombres de columnas
 */
...
class Libro {
    ...
    public function crear($datos) {
        ...
        $anio = $datos['anio_publicacion'] ?? $datos['año_publicacion'] ?? null;
    ...
    public function obtenerPorId($id) {
        ...
        if ($resultado) {
            ...
            $resultado['anio_publicacion'] = $resultado['anio_publicacion'];
    ...
    public function actualizar($id, $datos) {
        ...
        return $stmt->execute([
            ...
            $datos['anio_publicacion'] ?? $datos['año_publicacion'] ?? null,
    ...
    public function obtenerDisponibles() {
        ...
        foreach ($libros as &$libro) {
            ...
            $libro['anio_publicacion'] = $libro['anio_publicacion'];
            $libro['tipo'] = 'fisico';
            $libro['subtitulo'] = '';
        }
