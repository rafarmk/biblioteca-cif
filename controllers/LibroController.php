...
class LibroController {
    ...
    private function procesarExcel($archivo) {
        ...
        try {
            ...
            // Buscar la fila de encabezados (puede estar en fila 1-10)
            $headers = [];
            $filaEncabezado = 1;
            ...
            for ($row = 1; $row <= 10; $row++) {
                ...
                // Verificar si esta fila tiene encabezados válidos
                $contieneTexto = false;
                ...
                // Si encontramos texto, verificar si tiene columnas importantes
                if ($contieneTexto) {
            ...
            echo "<h2 style='color: red;'>DEBUG - Informacion del Excel:</h2>";
            echo "<p><strong>Fila de encabezados encontrada:</strong> $filaEncabezado</p>";
            echo "<h3 style='color: blue;'>Encabezados leidos:</h3>";
            ...
            echo "<h3 style='color: green;'>Columnas mapeadas:</h3>";
            echo "<pre style='background: white; padding: 10px;'>";
            print_r($columnas);
            echo "</pre>";
            echo "<p><strong>Total de filas:</strong> $highestRow</p>";
            echo "<p><strong>Filas a procesar:</strong> " . ($highestRow - $filaEncabezado) . "</p>";
            echo "</div>";
            // FIN DEBUG
