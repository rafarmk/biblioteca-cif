                        ...
                        <div class="activity-content">
                            ...
                            <div class="activity-details">
                                ...
                                <div class="activity-meta">
                                    ...
                                    <span class="meta-separator"></span>
                                    <span class="meta-item">
                                        <strong> Vence:</strong> <?php echo !empty($prestamo["fecha_devolucion_esperada"]) ? date("d/m/Y", strtotime($prestamo["fecha_devolucion_esperada"])) : date("d/m/Y", strtotime($prestamo["fecha_prestamo"] . " +7 days")); ?>
                                    </span>
                                </div>
                            </div>
                        </div>
